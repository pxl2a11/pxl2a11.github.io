...
const changelogData = [
    ...
    { date: getRussianDate('2025-09-23T10:00:00Z'), appName: 'Сжатие аудио', description: 'полностью переработан дизайн и логика приложения. Добавлена возможность отдельно включать/выключать нормализацию громкости (с ручным вводом LUFS) и сжатие аудио, что позволяет гибко настраивать обработку.' },
