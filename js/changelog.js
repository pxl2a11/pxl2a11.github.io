...
const changelogData = [
    { date: getRussianDate('2025-09-29T10:00:00Z'), appName: 'Генератор рифм', description: 'добавлено новое творческое приложение для подбора рифм к словам, которое будет полезно поэтам и авторам текстов.' },
