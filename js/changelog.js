...
const changelogData = [
    { date: getRussianDate('2025-09-11T09:00:00Z'), appName: 'Калькулятор калорий', description: 'добавлено новое приложение для расчета суточной нормы калорий для поддержания, потери или набора веса.' },
    { date: getRussianDate('2025-09-10T10:00:00Z'), appName: 'Виртуальный кубик', description: 'добавлено новое приложение для броска игральных костей (d4, d6, d8, d10, d12, d20) с выбором количества.' },
    { date: getRussianDate('2025-09-09T11:00:00Z'), appName: 'Анализатор текста', description: 'приложение было объединено со "Счетчиком слов и символов". Теперь оно включает в себя всю статистику: количество слов, символов, предложений, абзацев, время чтения и анализ ключевых слов.' },
