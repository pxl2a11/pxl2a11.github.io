...
const changelogData = [
    ...
    { date: getRussianDate('2025-09-12T15:00:00Z'), appName: 'Заметки и задачи', description: 'улучшен интерфейс редактирования: теперь для изменения достаточно кликнуть на текст, добавлена возможность удаления отдельных задач, иконки удаления отображаются постоянно.' },
