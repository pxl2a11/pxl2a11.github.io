            ...
            <div class="md:col-span-1 flex flex-col items-center p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl shadow-lg">
                ...
                <div class="flex items-center gap-2 mt-6 w-full max-w-xs">
                    <button id="mute-btn" title="Выключить звук" class="p-2 text-gray-600 dark:text-gray-300 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600">
                        <svg id="volume-on-icon" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"><path d="M10 3a1 1 0 0 0-1.555-.832L3 6H1a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2l5.445 3.832A1 1 0 0 0 10 17V3Zm-3.25 6a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5h-.5ZM12.94 5.94a.75.75 0 0 1 1.06 1.06L12.5 8.56l1.5 1.5a.75.75 0 1 1-1.06 1.06l-1.5-1.5-1.5 1.5a.75.75 0 1 1-1.06-1.06l1.5-1.5-1.5-1.5a.75.75 0 0 1 1.06-1.06l1.5 1.5 1.5-1.5Z" clip-rule="evenodd" /></svg>
                        <svg id="volume-off-icon" class="w-6 h-6 hidden" fill="currentColor" viewBox="0 0 20 20"><path d="M10 3a1 1 0 0 0-1.555-.832L3 6H1a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2l5.445 3.832A1 1 0 0 0 10 17V3Zm3.75 6a.75.75 0 0 0 0-1.5H12a.75.75 0 0 0 0 1.5h1.75Z" clip-rule="evenodd" /></svg>
                    </button>
