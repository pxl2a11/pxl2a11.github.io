        ...
        return `
            <div class="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4 first:mt-0 first:pt-0 first:border-0">
                ...
                <div class="mt-2 text-gray-800 dark:text-gray-300">
                    <a href="#" data-app-name="${entry.appName}" class="changelog-link font-bold underline text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">${entry.appName}.</a>
                    ${descriptionsHtml}
                </div>
            </div>
        `;
