...
const emojiStrings = {
    ...
    'Объекты': '⌚📱📲💻⌨️🖥️🖨️🖱️🖲️🕹️🗜️💽💾💿📀📼📷📸📹🎥📽️🎞️📞☎️📟📠📺📻🎙️🎚️🎛️🧭⏱️⏲️⏰🕰️⌛⏳📡🔋🔌💡🔦🕯️🧯💸💵💴💶💷🪙💰💳💎⚖️🪜🧰🪛🔧🔨⚒️🛠️⛏️🔩⚙️🧱⛓️🪝🔗💉🩸🧬🔬🔭📡🛰️🪠🪣🧴🛎️🔑🗝️🛋️🪑🛌🛏️🚪🪞🚽🚿🛁🪤🪄🚬⚰️🪦⚱️🏺🗺️🗾🏔️⛰️🌋🗻🏕️🏖️🏜️🏝️🏞️🏟️🏛️🏗️🪨🪵🛖🏘️🏚️🏠🏡🏢🏣🏤🏥🏦🏨🏩🏪🏫🏬🏭🏯🏰💒🗼🗽⛪🕌🛕🕍⛩️🕋⛲⛺🌁🌃🏙️🌄🌅🌆🌇🌉♨️🎠🎡🎢💈🎪🚂🚃🚄🚅🚆🚇🚈🚉🚊🚝🚞🚋🚌🚍🚎🚐🚑🚒🚓🚔🚕🚖🚗🚘🚙🛻🚚🚛🚜',
...
export function init() {
    ...
    function setupIntersectionObserver() {
        ...
        contentArea.querySelectorAll('section').forEach(section => observer.observe(section));
    }
