...
const changelogData = [
    { date: getRussianDate('2025-08-11T13:00:00Z'), appName: 'Эмодзи и символы', description: 'приложение полностью переписано с нуля с новым двухколоночным интерфейсом, плавной прокруткой и интеллектуальной навигацией по категориям.' },
