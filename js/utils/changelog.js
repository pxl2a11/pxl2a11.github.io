...
export const appNameToModuleFile = {
    ...
    'Счетчик слов и символов': 'wordCounter', // ДОБАВЛЕНО
    'Сканер QR-кодов': 'qrScanner',         // ДОБАВЛЕНО
    'Простой синтезатор (Пианино)': 'piano', // ДОБАВЛЕНО
...
const changelogData = [
    // --- НОВЫЕ ЗАПИСИ ---
    { date: getRussianDate('2025-08-09T10:00:00Z'), appName: 'Простой синтезатор (Пианино)', description: 'добавлено новое приложение-пианино для игры с помощью мыши и клавиатуры.' },
