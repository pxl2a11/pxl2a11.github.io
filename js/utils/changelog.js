...
const changelogData = [
    ...
    { date: getRussianDate('2025-08-13T10:00:00Z'), appName: 'Эмодзи и символы', description: 'исправлена ошибка, из-за которой не работало меню навигации по категориям.' },
    ...
    { date: getRussianDate('2025-08-12T09:00:00Z'), appName: 'Эмодзи и символы', description: 'значительно расширена база ключевых слов для поиска по всем эмодзи и символам.' },
    ...
    // --- ПРЕДЫДУЩИЕ ЗАПИСИ (из вашего файла) ---
    ...
    { date:     { date: getRussianDate('2025-08-08T12:00:00Z'), appName: 'Калькулятор процентных соотношений', description: 'добавлено новое приложение для быстрых расчетов с процентами.' },
    ...
    { date: getRussianDate('2025-08-05T00:00:00Z'), appName: 'Крестики-нолики', description: 'добавлен режим игры с компьютером (простой AI) и возможность сменить режим или начать заново.' },getRussianDate('2025-08-04T00:00:00Z'), appName: 'Общее', description: 'начальная версия проекта.' }
];
