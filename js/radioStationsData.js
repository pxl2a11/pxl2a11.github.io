...
export const radioStations = [
    ...
    { name: "Радио Зенит", logoUrl: "img/radio/radio_zenit.png", streams: [
    ...
    { name: "Юмор FM", logoUrl: "img/radio/yumor_fm.png", streams: [
    ...
    { name: "Маруся FM", logoUrl: "img/radio/marusya_fm.png", streams: [{ name: "Основной поток", url: "https://msk8.radio-holding.ru/marusya_default" }] },
    { name: "Record Russian Hits", logoUrl: "img/radio/record_russian_hits.png", streams: [{ name: "Основной поток", url: "https://stream.pcradio.ru/record_rushits-med" }] },
    { name: "Relax FM", logoUrl: "img/radio/relax_fm.png", streams: [
        { name: "64 kbps", url: "https://pub0201.101.ru/stream/air/aac/64/200" },
        { name: "128 kbps", url: "https://hls-01-gpm.hostingradio.ru/relaxfm495/128/playlist.m3u8" }] },
    { name: "Соль FM", logoUrl: "img/radio/sol_fm.png", streams: [
        { name: "Основной поток", url: "https://stream.pcradio.ru/sol_fm-hi" }] },
    { name: "РУССКАЯ ВОЛНА", logoUrl: "img/radio/russkaya_volna.png", streams: [
        { name: "Поток 48kbps", url: "https://ru1.amgradio.ru/RuWave48" }] },
    { name: "РЕТРО ХИТ", logoUrl: "img/radio/retro_hit.png", streams: [
        { name: "Основной поток", url: "https://retro.amgradio.ru/Retro" }] },
    { name: "РУССКИЙ РОК", logoUrl: "img/radio/russkij_rok.png", streams: [
        { name: "Основной поток", url: "https://rock.amgradio.ru/RusRock" }] },
    { name: "ХАЙП FM", logoUrl: "img/radio/hajp_fm.png", streams: [
        { name: "Основной поток", url: "https://hfm.amgradio.ru/HypeFM" }] },
    { name: "REMIX FM", logoUrl: "img/radio/remix_fm.png", streams: [
        { name: "Основной поток", url: "https://rmx.amgradio.ru/RemixFM" }] },
    { name: "DEEP FM", logoUrl: "img/radio/deep_fm.png", streams: [
        { name: "Основной поток", url: "https://deep.amgradio.ru/DeepFM" }] },
    { name: "MEGA RADIO", logoUrl: "img/radio/mega_radio.png", streams: [
        { name: "Основной поток", url: "https://mega.amgradio.ru/mega" }] },
    { name: "RADIO CAFE", logoUrl: "img/radio/radio_cafe.png", streams: [
        { name: "Основной поток", url: "https://cafe.amgradio.ru/Cafe" }] },
    { name: "ХОРОШЕЕ РАДИО", logoUrl: "img/radio/horoshee_radio.png", streams: [
        { name: "Основной поток", url: "https://hr.amgradio.ru/Horoshee" }] },
    { name: "РУССКОЕ FM", logoUrl: "img/radio/russkoe_fm.png", streams: [
        { name: "Основной поток", url: "https://rufm.amgradio.ru/rufm" }] },
    { name: "RADIO FRESH", logoUrl: "img/radio/radio_fresh.png", streams: [
        { name: "Основной поток", url: "https://fresh.amgradio.ru/Fresh" }] },
    { name: "МУРКА FM", logoUrl: "img/radio/murka_fm.png", streams: [
        { name: "Основной поток", url: "https://murka.amgradio.ru/MurkaFM" }] },
    { name: "РОДНЫЕ ПЕСНИ", logoUrl: "img/radio/rodnye_pesni.png", streams: [
        { name: "Основной поток", url: "https://rodpesni.amgradio.ru/rp" }] },
    { name: "РУССКИЕ ПЕСНИ", logoUrl: "img/radio/russkie_pesni.png", streams: [
        { name: "Основной поток", url: "https://rusongs.amgradio.ru/rusongs" }] },
    { name: "DJIN FM", logoUrl: "img/radio/djin_fm.png", streams: [
        { name: "Основной поток", url: "https://djin.amgradio.ru/djin" }] },
    { name: "ШТОРМ FM", logoUrl: "img/radio/shtorm_fm.png", streams: [
        { name: "Основной поток", url: "https://shtorm.amgradio.ru/shtormfm" }] },
    { name: "MUSIC BOX RADIO", logoUrl: "img/radio/music_box_radio.png", streams: [
        { name: "Основной поток", url: "https://musicbox.amgradio.ru/musicbox" }] },
    { name: "CHILLA FM", logoUrl: "img/radio/chilla_fm.png", streams: [
        { name: "Основной поток", url: "https://chilla.amgradio.ru/ChillaFM" }] },
    { name: "LITE FM", logoUrl: "img/radio/lite_fm.png", streams: [
        { name: "Основной поток", url: "https://litefm.amgradio.ru/litefm" }] },
    { name: "ДЕТСКИЙ ХИТ", logoUrl: "img/radio/detskij_hit.png", streams: [
        { name: "Основной поток", url: "https://deti.amgradio.ru/Deti" }] },
    { name: "СКАЗКА FM", logoUrl: "img/radio/skazka_fm.png", streams: [
        { name: "Основной поток", url: "https://skazka.amgradio.ru/Skazka" }] },
    { name: "УМНОЕ РАДИО", logoUrl: "img/radio/umnoe_radio.png", streams: [
        { name: "Основной поток", url: "https://umnoe.amgradio.ru/Umnoe" }] },
    { name: "LATINO RADIO", logoUrl: "img/radio/latino_radio.png", streams: [
        { name: "Основной поток", url: "https://latino.amgradio.ru/latino" }] },
    { name: "РАДИО МЕЧТА", logoUrl: "img/radio/radio_mechta.png", streams: [
        { name: "Основной поток", url: "https://mechta.amgradio.ru/mechta" }] },
    { name: "RADIO FUNK", logoUrl: "img/radio/radio_funk.png", streams: [
        { name: "Основной поток", url: "https://funk.amgradio.ru/Funk" }] },
    { name: "RBS FM", logoUrl: "img/radio/rbs_fm.png", streams: [
        { name: "Основной поток", url: "https://rbs.amgradio.ru/rbs" }] },
    { name: "MAKKIRUS", logoUrl: "img/radio/makkirus.png", streams: [
        { name: "Основной поток", url: "https://makkirus.amgradio.ru/makkirus" }] },
    { name: "CLASSIC FM", logoUrl: "img/radio/classic_fm.png", streams: [
        { name: "Основной поток", url: "https://classic.amgradio.ru/ClassicFM" }] },
    { name: "РАДИО ЗВУКИ ПРИРОДЫ", logoUrl: "img/radio/radio_zvuki_prirody.png", streams: [
        { name: "Основной поток", url: "https://zvuki.amgradio.ru/Zvuki" }] },
    { name: "Спутник Радио", logoUrl: "img/radio/sputnik_radio.png", streams: [
        { name: "Основной поток", url: "https://stream.pcradio.ru/sputnik_ria_ru-med" }] },
    { name: "ТНТ Music Radio", logoUrl: "img/radio/tnt_music_radio.png", streams: [
